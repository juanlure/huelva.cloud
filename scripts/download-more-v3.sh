#!/bin/bash
# Descarga más imágenes de Huelva - Tercera tanda
# Temas que faltan para artículos específicos
...
echo "🖼️  Descargando más imágenes (tercera tanda)..."
echo ""

# Más búsquedas específicas
download_search "casa-pinzon" "Casa Pinzon Palos Frontera"
download_search "fuente-santa" "Fuente Santa Palos"
download_search "muelle-carabelas" "Muelle Carabelas Huelva"
download_search "estacion-tren-huelva" "Estacion tren Huelva"
download_search "gran-via-huelva" "Gran Via Huelva"
download_search "puente-internacional" "Puente Internacional Guadiana"
download_search "cala-huelva" "Cala playa Huelva"
download_search "aldea-rocio" "Aldea El Rocio"

echo ""
echo "📁 Total imágenes ahora: $(ls -1 "$OUTPUT_DIR"/*.jpg "$OUTPUT_DIR"/*.png 2>/dev/null | wc -l)"
