...
export const BARRIOS: Barrio[] = [
  ...
  },
  {
    ...
    name: "El Conquero",
    area: "Huelva capital",
    vibe: "La loma con villas, pino y vistas a la ría. Huelva se entiende desde arriba: industria, marismas y atardecer de verdad.",
    ...
    secret: "El paseo del Moret al anochecer, cuando el Polo Químico se enciende al fondo y nadie saca el móvil.",
  ...
  },
  {
    ...
    name: "Isla Chica",
    area: "Huelva capital",
    vibe: "El barrio más vivo y más de verdad: bloques, comercios, fútbol en la calle. Huelva sin filtro de postal.",
    stay: "Barato y céntrico en espíritu. No es la postal que vende el folleto.",
    eat: "Bares de toda la vida, raciones generosas, poco Instagram.",
  ...
  },
  {
    ...
    name: "Punta Umbría",
    area: "Costa",
    vibe: "La playa de los onubenses. Choco, gamba, paseo marítimo y un verano que empieza en mayo. No es Marbella y se nota, para bien.",
  ...
  },
  {
    ...
    eat: "Turístico. Come decente y reserva el presupuesto para un centro de visitantes.",
  ...
  },
  {
    ...
    area: "Sierra",
    vibe: "Castaños, jamón de Jabugo y pueblos que huelen a encina. La otra Huelva, la que no sale en la toalla.",
    ...
    secret: "Jabugo a primera hora, antes de las tiendas de souvenir. Entra en un secadero si te dejan.",
