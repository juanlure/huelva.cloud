    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
      ...
      <section className="mt-10 space-y-4 rounded-xl border border-line bg-paper p-6">
        ...
        <p className="text-muted">
          Mándanos un email a{" "}
          <a href="mailto:jlromero@flowia.pro" className="text-tide hover:underline">
            jlromero@flowia.pro
          </a>{" "}
          con el nombre del local, qué queréis destacar, y si preferís mesa o bodega. Escribe a jlromero@flowia.pro y te pasamos el pago.
        </p>
      ...
      <section className="mt-12 space-y-3 text-sm text-muted">
        ...
        <p className="mt-4">
          ...
          casa, <a href="mailto:jlromero@flowia.pro" className="text-tide hover:underline">escribe</a>.
        </p>
      </section>
