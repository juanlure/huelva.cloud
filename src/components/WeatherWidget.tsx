...
const weatherCodes: Record<number, { icon: React.ReactNode; label: string; description: string; bg: string }> = {
  ...
  71: { icon: <Snowflake size={48} />, label: 'Nieve ligera', description: 'Nieve ligera', bg: 'from-slate-200 to-slate-300' },
  73: { icon: <Snowflake size={48} />, label: 'Nieve moderada', description: 'Nieve moderada', bg: 'from-slate-300 to-slate-400' },
  75: { icon: <Snowflake size={48} />, label: 'Nieve fuerte', description: 'Nieve fuerte', bg: 'from-slate-400 to-slate-500' },
